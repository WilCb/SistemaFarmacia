                        ...
                        while True:
                            ...
                            if event == 'Consultar':
                                ...
                                layout = [
                                    ...
                                    [sg.Table(values=[values['nome']], headings=[['Nome'], ['Preço'], ['Quantidade']], expand_x=True, key='Table')],
                                    [sg.Button('Excluir'), sg.Button('Voltar')]
                                ]
                            ...
                            if registro:
                                with open('relatório.html', 'w', encoding='utf-8') as f:
                                    f.write("<html><head><meta charset='UTF-8'><style> * {"
                                            ...
                                            "}"
                                            "</style></head><body>")
                                    f.write("<section class='container'><h1>Relatório de produtos em estoque</h1><table border='1'><tr><th>Nome</th><th>Preço</th><th>Quantidade</th><th>Fórmula</th></tr>")
